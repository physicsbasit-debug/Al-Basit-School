...
">
    ...
    <div class="masar-login-title-motion" style="
        --masar-title-accent:{accent};
        font-size:30px;
        font-weight:950;
        color:{accent};
...
css += '\n/* Masar login title motion only - light readable 3D version */\n.masar-login-title-motion {\n    display: inline-block;\n    position: relative;\n    padding: 0 10px;\n    color: var(--masar-title-accent, #ffca28) !important;\n    transform-origin: center center;\n    transform-style: preserve-3d;\n    text-shadow:\n        0 1px 0 rgba(171,112,0,0.88),\n        0 2px 0 rgba(116,76,0,0.66),\n        0 3px 0 rgba(70,46,0,0.34),\n        0 7px 10px rgba(0,0,0,0.42),\n        0 0 10px rgba(255,202,40,0.34);\n    animation:\n        masarTitle3DGlow 4.8s ease-in-out infinite,\n        masarTitle3DDrift 5.8s ease-in-out infinite;\n    will-change: transform, text-shadow;\n}\n\n@keyframes masarTitle3DGlow {\n    0%, 100% {\n        text-shadow:\n            0 1px 0 rgba(171,112,0,0.88),\n            0 2px 0 rgba(116,76,0,0.66),\n            0 3px 0 rgba(70,46,0,0.34),\n            0 7px 10px rgba(0,0,0,0.42),\n            0 0 9px rgba(255,202,40,0.30);\n    }\n    50% {\n        text-shadow:\n            0 1px 0 rgba(197,133,0,0.95),\n            0 2px 0 rgba(138,92,0,0.72),\n            0 3px 0 rgba(83,55,0,0.42),\n            0 9px 14px rgba(0,0,0,0.50),\n            0 0 18px rgba(255,202,40,0.60);\n    }\n}\n\n@keyframes masarTitle3DDrift {\n    0%, 100% {\n        transform: perspective(720px) rotateX(0deg) rotateY(0deg) translateY(0) scale(1);\n    }\n    25% {\n        transform: perspective(720px) rotateX(1.1deg) rotateY(-1.6deg) translateY(-1px) scale(1.006);\n    }\n    50% {\n        transform: perspective(720px) rotateX(0deg) rotateY(1.6deg) translateY(-2px) scale(1.012);\n    }\n    75% {\n        transform: perspective(720px) rotateX(-1.1deg) rotateY(-0.8deg) translateY(-1px) scale(1.006);\n    }\n}\n\n@media (prefers-reduced-motion: reduce) {\n    .masar-login-title-motion {\n        animation: none !important;\n        transform: none !important;\n    }\n}\n'
