...
css += '\n/* Masar login title motion only - safe readable glow version */\n.masar-login-title-motion {\n    display: inline-block;\n    position: relative;\n    padding: 0 8px;\n    color: var(--masar-title-accent, #ffca28) !important;\n    text-shadow:\n        0 2px 4px rgba(0,0,0,0.45),\n        0 0 8px rgba(255,202,40,0.28);\n    animation:\n        masarTitleSoftGlow 4.8s ease-in-out infinite,\n        masarTitleFloat 5.8s ease-in-out infinite;\n    will-change: transform, text-shadow;\n}\n\n@keyframes masarTitleSoftGlow {\n    0%, 100% {\n        text-shadow:\n            0 2px 4px rgba(0,0,0,0.45),\n            0 0 6px rgba(255,202,40,0.22);\n    }\n    50% {\n        text-shadow:\n            0 2px 5px rgba(0,0,0,0.48),\n            0 0 14px rgba(255,202,40,0.55);\n    }\n}\n\n@keyframes masarTitleFloat {\n    0%, 100% {\n        transform: translateY(0) scale(1);\n    }\n    50% {\n        transform: translateY(-2px) scale(1.012);\n    }\n}\n\n@media (prefers-reduced-motion: reduce) {\n    .masar-login-title-motion {\n        animation: none !important;\n        transform: none !important;\n    }\n}\n'
